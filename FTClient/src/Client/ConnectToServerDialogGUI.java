...
public class ConnectToServerDialogGUI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("IPv4 do Servidor");

        jLabel2.setText("Porto do Servidor");

        jLabel3.setText("Nome");

        ligarServidorButton.setText("Ligar-se ao Servidor");
        ...
        jLabel4.setText("Pasta para Partilhar");

        escolherPastaButton.setText("Escolher Pasta");
        ...
        jLabel5.setText("Porto para Receção de Ficheiros");

        jLabel6.setText("Porto para Comunicações na Rede");
